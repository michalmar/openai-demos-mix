...
def fill_search():
    ...
    chunks = [
        ...
        {"Header": "Being a goods vehicle operator",
        "Description": "Information about becoming a goods vehicle operator, getting a goods vehicle licence and complying with regulations",
        },
        {"Header": "Apply for a licence to keep a wild animal",
        "Description": "You need a licence to keep certain kinds of wild or dangerous animals: contact your council for more information",  
        }
    ]
